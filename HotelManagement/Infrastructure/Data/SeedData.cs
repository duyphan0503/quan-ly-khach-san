...
public static class SeedData
{
        ...
        RoleManager<IdentityRole> roleManager)
    {
        ...
        await CreateUserIfNotExists(userManager, "manager@hotel.com", "Hotel@123", "Admin Manager", "Manager");
        await CreateUserIfNotExists(userManager, "le.reception@hotel.com", "Hotel@123", "Lê Thị Hương", "Receptionist");
    ...
    private static async Task SeedRoomTypesAsync(AppDbContext context)
    {
    ...
    private static async Task SeedRoomsAsync(AppDbContext context)
    {
        ...
        // Using FrozenDictionary for high-performance lookup during seeding
        var typesDict = (await context.RoomTypes.ToListAsync())
            .ToFrozenDictionary(rt => rt.Name, rt => rt.Id);

        context.Rooms.AddRange([
            // Tầng 1
            new Room { RoomNumber = "101", RoomTypeId = typesDict["Standard"], Floor = 1 },
            new Room { RoomNumber = "102", RoomTypeId = typesDict["Standard"], Floor = 1 },
            new Room { RoomNumber = "103", RoomTypeId = typesDict["Standard"], Floor = 1 },
            new Room { RoomNumber = "104", RoomTypeId = typesDict["Deluxe"],   Floor = 1 },
            // Tầng 2
            new Room { RoomNumber = "201", RoomTypeId = typesDict["Deluxe"],   Floor = 2 },
            new Room { RoomNumber = "202", RoomTypeId = typesDict["Deluxe"],   Floor = 2 },
            new Room { RoomNumber = "203", RoomTypeId = typesDict["Suite"],    Floor = 2 },
            // Tầng 3
            new Room { RoomNumber = "301", RoomTypeId = typesDict["Suite"],    Floor = 3 },
            new Room { RoomNumber = "302", RoomTypeId = typesDict["VIP"],      Floor = 3 },
            // Tầng 4
            new Room { RoomNumber = "401", RoomTypeId = typesDict["VIP"],      Floor = 4 },
            new Room { RoomNumber = "402", RoomTypeId = typesDict["VIP"],      Floor = 4 }
        ]);
        await context.SaveChangesAsync();
    }
